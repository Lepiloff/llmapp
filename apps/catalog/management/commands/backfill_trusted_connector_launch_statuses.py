"""Backfill source-backed launch statuses for trusted cloud connectors."""
...
from apps.catalog.trust import (
    ...
    trusted_connector_launch_statuses_backfill,
)
...
class Command(BaseCommand):
    help = (
        "Dry-run/apply launch_status backfill from trusted official cloud "
        "connector source text."
    )
    ...
    def add_arguments(self, parser) -> None:
        ...
        parser.add_argument(
            "--apply",
            action="store_true",
            help="Persist source-backed launch_status changes.",
        )
        parser.add_argument(
            "--indent",
            type=int,
    ...
    def handle(self, *args, **options) -> None:
        ...
        result = trusted_connector_launch_statuses_backfill(
